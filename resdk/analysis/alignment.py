...
def bowtie2(resource, genome, mode=None, speed=None, use_se=None, discordantly=None, rep_se=None,
    ...
    :param str mode: alignment mode (options are: --end-to-end, --local),
    ...
    :param bool use_se: map as single-ended (for paired-end reads only),
        default is False
    ...
    :param int trim_nucl: number of bases to trim from 3' in each iteration,
    default is 0
    :param str rep_mode: report mode (options are: def, k, a), default is def
    :param int k_reports: number of reports (for -k mode only), default is 5
